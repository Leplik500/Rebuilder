...
//         app.MapGet("~/api/order/{id}/price", GetTotalPrice)
//             .WithOpenApi()
//             .WithTags("Order");
//         app.MapPost($"~/api/order/create", CreateOrder)
//             .WithOpenApi()
//             .WithTags("Order");
//
...
//             new OrderGetTotalPriceRequest(id),
...
//     {
//         var result = await mediator.Send(
//             new OrderCreateCommand(creationModel),
//             httpContext.RequestAborted
//         );
//         return Results.Extensions.Custom(result);
//     }
